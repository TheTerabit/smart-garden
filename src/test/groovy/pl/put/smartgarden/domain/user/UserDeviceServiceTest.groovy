...
class UserDeviceServiceTest extends Specification {
    ...
    def "Should get measures of the selected area"() {
        ...
        sensor1.measures = Arrays.asList(
                ...
                new Measure(Instant.ofEpochSecond(1234577), 15, 1, 1),
                new Measure(Instant.ofEpochSecond(1234587), 16, 1, 1),
                new Measure(Instant.ofEpochSecond(1234597), 17, 1, 1),
                new Measure(Instant.ofEpochSecond(1234667), 20, 1, 1))
        ...
        sensor2.measures = Arrays.asList(
                ...
                new Measure(Instant.ofEpochSecond(1234577), 35, 2, 1),
                new Measure(Instant.ofEpochSecond(1234587), 46, 2, 1),
                new Measure(Instant.ofEpochSecond(1234597), 57, 2, 1),
                new Measure(Instant.ofEpochSecond(1234668), 60, 2, 1))
        ...
        sensor3.measures = Arrays.asList(
                ...
                new Measure(Instant.ofEpochSecond(1234690), 444, 3, 1))
        ...
        device.sensors = Arrays.asList(sensor1, sensor2, sensor3)
